...
const REGISTRY = {
  ...
  cvsr_2026_08_forecast: {
    partOf: 'cvsr_2026_08',
    title: 'CVS 119 Track and System Installation Forecast',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/08/FA-Central-Valley-Status-Report-August-2026-A11Y.pdf#page=11',
    page: 'p. 11',
    note: 'Published as a chart image; mileages and quarter ranges are transcribed from the slide.',
  },
  cvsr_2026_08_railhead: {
    partOf: 'cvsr_2026_08',
    title: 'Railhead overview',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/08/FA-Central-Valley-Status-Report-August-2026-A11Y.pdf#page=38',
    page: 'pp. 3, 38',
  },
  ...
  tscc_2025_presentation: {
    title: 'Release of a Request for Proposals (RFP) for the Track and Systems Construction Contract (TSCC) procurement',
    date: '2025-11-20',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2025/11/2025-11-20-Agenda-Item-3-PPT-TSCC-V1-A11Y.pdf',
  },
  tscc_2025_packages: {
    partOf: 'tscc_2025_presentation',
    title: 'Planned packages and track-start requirement',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2025/11/2025-11-20-Agenda-Item-3-PPT-TSCC-V1-A11Y.pdf',
    page: 'slides 4, 6-7',
    note: 'Nine-package count, the planned NTP 1-9 enumeration, and the contract track-start requirement.',
  },
  tscc_2025_term_sheet: {
    title: 'Track and Systems Construction Contract Term Sheet',
    date: '2025-11-20',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2025/11/2025-11-20-Agenda-Item-3-Term-Sheet-TSCC-V1-A11Y.pdf',
    page: 'pp. 1-8',
    note: 'Not the full contract; package sequencing and pricing may be revised.',
  },
  tscc_award_presentation_2026: {
    title: 'Approval to Award and Execute Track and Systems Construction Contract (TSCC)',
    date: '2026-06-01',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/05/2026-06-01-Agenda-Item-3-Track-and-Systems-PPT-V1-A11Y.pdf',
  },
  tscc_award_packages_2026: {
    partOf: 'tscc_award_presentation_2026',
    title: 'Awarded packages and Package 2 milestones',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/05/2026-06-01-Agenda-Item-3-Track-and-Systems-PPT-V1-A11Y.pdf',
    page: 'slides 5-7',
  },
  tscc_resolution_2026: {
    title: 'Resolution HSRA 26-07 - Approval to Execute and Award the Track & Systems Construction Contract and Issue Notices to Proceed for Package 1B and Package 2',
    date: '2026-06-01',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/06/2026-06-01-Agenda-Item-3-Track-and-Systems-Final-Resolution-V1-A11Y.pdf',
    page: 'pp. 1-2',
    note: 'Binding award and initial notice-to-proceed authorization.',
  },

  m2m_board_presentation_2026: {
    title: 'Issuance of a Request for Qualifications (RFQ) for the Merced to Madera (M2M) Civil Works Collaborative Design-Build procurement',
    date: '2026-06-24',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/06/2026-06-24-Agenda-Item-4-M2M-PPT-A11Y.pdf',
    page: 'slides 2-8',
    note: 'Original board request; superseded on schedule and value by the July 2026 material.',
  },
  m2m_resolution_2026: {
    title: 'Resolution HSRA 26-10 - Approval to Release a Request for Qualifications for Collaborative Design-Build Services for Merced to Madera Civil Works and Award Pre-Proposal Collaboration Agreements',
    date: '2026-06-24',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/06/2026-06-24-Agenda-Item-4-M2M-Final-Resolution-HSR26-10-A11Y.pdf',
    page: 'pp. 1-2',
    note: 'Authorizes the RFQ and two collaboration agreements, not a design-build award.',
  },
  m2m_rfq_2026: {
    title: 'Cal eProcure Event HSR26-16 - Merced to Madera Civil Works',
    date: '2026-07-31',
    accessed: '2026-08-14',
    publisher: 'California Department of General Services, California State Contracts Register',
    url: 'https://caleprocure.ca.gov/event/2665/HSR26-16',
    note: 'Current RFQ Addendum 1 as checked August 14, 2026; supersedes the June 24 draft.',
  },
  m2m_rfq_sections_2026: {
    partOf: 'm2m_rfq_2026',
    title: 'Section limits, Figure 1, and scope of work',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://caleprocure.ca.gov/event/2665/HSR26-16',
    page: 'Addendum 1, Exhibit A, pp. 2-8',
  },
  m2m_prebid_2026: {
    title: 'M2M Civil Works Pre-Bid Presentation',
    date: '2026-07-16',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/wp-content/uploads/2026/07/M2M-Pre-Bid-Presentation-A11Y.pdf',
    page: 'slides 24-38',
    note: 'Current procurement schedule and value, the approximately 30% reference-design scope, and the major-segments figure.',
  },
  m2m_procurement_2026: {
    title: 'Merced to Madera Civil Works',
    accessed: '2026-08-14',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/work-with-us/procurements/architectural-engineering-and-capital-contracts/merced-to-madera-civil-works/',
    note: 'Live procurement status page.',
  },
  procurement_schedule_2026: {
    title: 'Procurement Schedule',
    accessed: '2026-08-14',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/work-with-us/procurements/procurement-schedule/',
    note: 'Live schedule; the LGA entry is the Authority’s own current status for that procurement.',
  },
  lga_environmental_record: {
    title: 'Fresno to Bakersfield: Locally Generated Alternative - Environmental Documents',
    date: '2019-10-31',
    accessed: '2026-08-14',
    publisher: 'California High-Speed Rail Authority',
    url: 'https://hsr.ca.gov/programs/environmental-planning/project-section-environmental-documents-tier-2/fresno-to-bakersfield-locally-generated-alternative/',
    note: 'Approved environmental alignment context, not a construction contract.',
  },
